/* Generated By:JavaCC: Do not edit this line. assignment_oneTokenManager.java */
import java.io.*;
import java.util.*;

/** Token Manager. */
public class assignment_oneTokenManager implements assignment_oneConstants
{
...
private static final int jjStopStringLiteralDfa_0(int pos, long active0)
{
   switch (pos)
   {
      ...
      case 2:
         ...
         return -1;
      case 3:
         if ((active0 & 0x49b0000L) != 0L)
            return 7;
         if ((active0 & 0x160f000L) != 0L)
         {
            jjmatchedKind = 47;
            jjmatchedPos = 3;
            return 7;
...
null, "\54", "\72", "\73", "\173", "\175", "\50", "\51", "\75", "\53", "\55", 
...
/** Constructor. */
public assignment_oneTokenManager(SimpleCharStream stream){
...
/** Constructor. */
public assignment_oneTokenManager(SimpleCharStream stream, int lexState){
   this(stream);
   SwitchTo(lexState);
}
